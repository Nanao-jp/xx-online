...
export const serverProducts: ServerProduct[] = [
  {
    ...
    specs: [
      ...
      { label: '管理', value: 'iBMCチップ搭載 (Redfish, SNMP, IPMI 2.0対応)。オプションの管理ソフトウェア対応' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: '管理', value: 'iBMCチップは、1つの管理用GEネットワークポートを統合しており、故障診断、自動O&M、ハードウェアセキュリティ強化などの包括的な管理機能を提供 • iBMCは、Redfish、SNMP、IPMI 2.0などの標準インターフェースに対応し、HTML5/VNC KVMに基づいたリモート管理ユーザーインターフェースを提供し、監視、診断、設定、エージェントレス、リモートコントロールなどの、管理の複雑さを簡素化する帯域外管理機能をサポート • オプションの管理ソフトウェアは、5つのインテリジェントテクノロジーなどの高度な管理機能を提供することで、ライフサイクル全体にわたるインテリジェント化・自動化・視覚化・洗練された管理を実現' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: '管理', value: 'iBMCチップは、1つの管理用GEネットワークポートを統合しており、故障診断、自動O&M、ハードウェアセキュリティ強化などの包括的な管理機能を提供。iBMCは、Redfish、SNMP、IPMI 2.0などの標準インターフェースに対応し、HTML5/VNC KVMに基づいたリモート管理ユーザーインターフェースを提供し、監視、診断、設定、エージェントレス、リモートコントロールなどの、管理の複雑さを簡素化する帯域外管理機能をサポート。オプションの管理ソフトウェアは、5つのインテリジェントテクノロジーなどの高度な管理機能を提供し、ライフサイクル全体にわたるインテリジェント化・自動化・視覚化・洗練された管理を実現' },
      { label: 'セキュリティ特性', value: 'パワーオンパスワード、管理者パスワード、TPM 2.0、セキュリティベゼル、セキュアブート、カバーオープン検知' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: '管理', value: 'iBMCチップによる包括的な管理機能。Redfish、SNMP、IPMI 2.0などの標準インターフェースに対応。オプションの管理ソフトウェア' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: '管理', value: 'iBMCチップによる包括的な管理機能。Redfish、SNMP、IPMI 2.0などの標準インターフェース対応。HTML5/VNC KVMベースのリモート管理UI。オプションの管理ソフトウェアで高度な管理機能を提供' },
      { label: 'セキュリティ特性', value: 'パワーオンパスワード、管理者パスワード、TPM 2.0、セキュリティベゼル、セキュアブート、カバーオープン検知' },
      { label: '動作温度', value: '5°C～35°C（ASHRAE Class A1/A2に準拠）' },
      { label: '認証', value: 'CE、UL、CCC、FCC、VCCI、RoHS' },
      { label: '取り付けレール', value: 'L型レール、伸縮レール、ホールディングレール' },
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '高効率な放熱：業界独自のGPUと組み合わせたMPCアルゴリズムにより、ファンの消費電力を1.1%削減。独自設計の高性能ファンを採用することで、放熱能力20%～30%改善、およびエネルギー効率16%向上を実現'
        ]
      }
    ],
    reliability: [
