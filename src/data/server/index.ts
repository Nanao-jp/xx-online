  ...
  },
  {
    ...
    reliability: [
      ...
      },
      {
        title: 'システムのダウンタイムが66%削減',
        description: '自社開発したAIメモリー障害自己修復機能により、システムの安定稼働を保証',
        image: '/products/servers/dfx-dh116-v1/high-reliability.jpg' // Placeholder, adjust if needed
      }
    ],
    energySaving: {
      image: '/products/servers/dfx-dh116-v1/energy-saving.jpg', // Placeholder, adjust if needed
      imagePosition: 'bottom',
      points: [
        {
          icon: 'BatteryCharging',
