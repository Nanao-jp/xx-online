...
export const serverProducts: ServerProduct[] = [
  {
    ...
    mainImage: '/products/servers/g5200v7/g5200v7-ai-server.jpg',
    category: 'gpu-server',
    meta: {
    ...
    hero: {
      ...
      image: '/products/servers/g5200v7/g5200v7-ai-server.jpg'
    },
    introduction: {
      ...
      image: '/products/servers/g5200v7/main.jpg'
    },
    features: [
      {
        title: '超大容量ストレージ',
        description: 'AIの要求に応える大容量ストレージ構成に対応。柔軟なドライブオプションで、多様なワークロードをサポートします。',
        image: '/products/servers/g5200v7/large-storage.jpg',
        bullets: [
      ...
      },
      {
        ...
        image: '/products/servers/g5200v7/flexible-expansion.jpg',
        bullets: [
      ...
      },
      {
        title: '極めて優れた演算能力',
        description: '', // This one uses a list format directly
        image: '/products/servers/g5200v7/computing-power.jpg',
        bullets: [
    ...
    reliability: [
      {
        ...
        image: '/products/servers/g5200v7/heat-dissipation.jpg'
      },
      {
        title: 'システムのダウンタイムが66%削減',
        description: '自社開発したAIメモリー障害自己修復機能により、システムの安定稼働を保証',
        image: '/products/servers/g5200v7/high-reliability.jpg'
      }
    ],
    energySaving: {
      image: '/products/servers/g5200v7/energy-saving.jpg',
    ...
    datasheetUrl: '/products/servers/g5200v7/G5200-V7-Datasheet.pdf',
    shortFeatures: [
      '堅牢なパフォーマンス',
      '超大容量ストレージ',
      '柔軟な拡張性'
